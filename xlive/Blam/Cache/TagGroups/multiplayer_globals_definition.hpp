...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_general_events_block)
	...
	TAG_REFL_STRING_ID(plural_display_string)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_king_events_block::s_sound_permutations_block)
	TAG_REFL_PROPERTY(sound_flags)
	TAG_REFL_TAG_REFERENCE(english_sound)
	TAG_REFL_TAG_REFERENCE(japanese_sound)
	TAG_REFL_TAG_REFERENCE(german_sound)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_king_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
	TAG_REFL_STRING_ID(display_string)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_invasion_events_block::s_sound_permutations_block)
	TAG_REFL_PROPERTY(sound_flags)
	TAG_REFL_TAG_REFERENCE(english_sound)
	TAG_REFL_TAG_REFERENCE(japanese_sound)
	TAG_REFL_TAG_REFERENCE(german_sound)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_invasion_events_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(event)
	TAG_REFL_PROPERTY(audience)
	TAG_REFL_STRING_ID(display_string)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block::s_state_responses_block)
	...
	TAG_REFL_STRING_ID(ffa_message)
...
TAG_REFL_TAG_BLOCK_DEF(s_multiplayer_globals_group_definition::s_runtime_block)
	...
	TAG_REFL_TAG_REFERENCE(da_bomb)
	...
	TAG_REFL_PROPERTY(dynamic_zone_upper_height)
	TAG_REFL_PROPERTY(dynamic_zone_lower_height)
	...
	TAG_REFL_TAG_REFERENCE(scoreboard_hud_definition)
	TAG_REFL_TAG_REFERENCE(scoreboard_emblem_shader)
	TAG_REFL_TAG_REFERENCE(scoreboard_emblem_bitmap)
	TAG_REFL_TAG_REFERENCE(scoreboard_dead_emblem_shader)
	TAG_REFL_TAG_REFERENCE(scoreboard_dead_emblem_bitmap)
REFL_END
