...
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_havok_cleanup_resources_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_collision_damage_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_sound_globals_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_ai_globals_block::s_gravemind_properties_block)

TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_ai_globals_block)
	TAG_REFL_TAG_BLOCK(gravemind_properties)
REFL_END

TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_damage_table_block::s_damage_groups_block::s_armor_modifiers_block)
...
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_sounds_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_camera_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_player_control_block::s_look_function_block)

TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_player_control_block)
	TAG_REFL_TAG_BLOCK(look_function)
REFL_END

TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_difficulty_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_grenades_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_rasterizer_data_block::s_global_vertex_shaders_block)

TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_rasterizer_data_block)
	TAG_REFL_TAG_BLOCK(global_vertex_shaders)
REFL_END

TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_interface_tags_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_weapon_list_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_cheat_powerups_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_multiplayer_information_block::s_vehicles_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_multiplayer_information_block::s_sounds_block)
...
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_player_information_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_player_representation_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_falling_damage_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_old_materials_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_materials_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_multiplayer_ui_block::s_obsolete_profile_colors_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_multiplayer_ui_block::s_team_colors_block)
...
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_profile_colors_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_runtime_level_data_block::s_campaign_levels_block)
...
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_ui_level_data_block::s_campaigns_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_ui_level_data_block::s_campaign_levels_block)
TAG_REFL_TAG_BLOCK_FLAT(s_globals_group_definition::s_ui_level_data_block::s_multiplayer_levels_block)
