...
struct s_globals_group_definition :TagGroup<'matg'>
{
	...
	tag_block <s_weapon_list_block> weapons;//0x118
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_ai_globals_block)
	...
	TAG_REFL_PROPERTY(danger_exetended_shield_damage)
	TAG_REFL_PROPERTY(danger_body_damage)
	TAG_REFL_PROPERTY(danger_extended_body_damage)
	TAG_REFL_TAG_REFERENCE(global_dialogue_tag)
	...
	TAG_REFL_REAL_BOUNDS(hoist_step)
	TAG_REFL_REAL_BOUNDS(hoist_crouch)
	TAG_REFL_REAL_BOUNDS(hoist_stand)
	TAG_REFL_REAL_BOUNDS(vault_step)
	TAG_REFL_REAL_BOUNDS(vault_crouch)
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_player_control_block)
	...
	TAG_REFL_REAL_POINT2D(crosshair_location)
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_difficulty_block)
	...
	TAG_REFL_PROPERTY(imposs_overcharge_chance)
	...
	TAG_REFL_PROPERTY(imposs_special_fire_delay)
	...
	TAG_REFL_PROPERTY(imposs_melee_delay_scale)
	...
	TAG_REFL_PROPERTY(imposs_grenade_chance_scaley)
	...
	TAG_REFL_PROPERTY(imposs_grenade_timer_scale)
	TAG_REFL_PROPERTY(easy_major_upgrade_normal)
	TAG_REFL_PROPERTY(normal_major_upgrade_normal)
	TAG_REFL_PROPERTY(hard_major_upgrade_normaly)
	TAG_REFL_PROPERTY(imposs_major_upgrade_normal)
	...
	TAG_REFL_PROPERTY(imposs_major_upgrade_few)
	...
	TAG_REFL_PROPERTY(imposs_major_upgrade_many)
	...
	TAG_REFL_PROPERTY(imposs_player_vehicle_ram_chance)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_rasterizer_data_block)
	...
	TAG_REFL_TAG_REFERENCE(unused5)
	TAG_REFL_TAG_REFERENCE(unused6)
	TAG_REFL_TAG_REFERENCE(unused7)
	TAG_REFL_TAG_REFERENCE(unused8)
	TAG_REFL_TAG_REFERENCE(unused9)
	TAG_REFL_TAG_REFERENCE(unused10)
	TAG_REFL_TAG_REFERENCE(global_shader)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(refraction_amount)
	TAG_REFL_PROPERTY(distance_falloff)
	TAG_REFL_REAL_COLOR_RGB(tint_color)
	TAG_REFL_PROPERTY(hyperstealth_refraction)
	TAG_REFL_PROPERTY(hyperstealth_distance_falloff)
	TAG_REFL_REAL_COLOR_RGB(hyperstealth_tint_color)
	TAG_REFL_TAG_REFERENCE(unused11)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_interface_tags_block)
	...
	TAG_REFL_TAG_REFERENCE(pad)
	TAG_REFL_TAG_REFERENCE(hud_digits_definition)
	TAG_REFL_TAG_REFERENCE(motion_sensor_blip_bitmap)
	TAG_REFL_TAG_REFERENCE(interface_goo_map1)
	TAG_REFL_TAG_REFERENCE(interface_goo_map2)
	TAG_REFL_TAG_REFERENCE(interface_goo_map3)
	TAG_REFL_TAG_REFERENCE(mainmenu_ui_globals)
	TAG_REFL_TAG_REFERENCE(singleplayer_ui_globals)
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_player_information_block)
	...
	TAG_REFL_PROPERTY(airborne_acceleration)
	...
	TAG_REFL_REAL_BOUNDS(first_person_idle_time)
	...
	TAG_REFL_PROPERTY(binoculars_zoom_range_lower)
	TAG_REFL_PROPERTY(binoculars_zoom_range_upper)
...
TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_player_representation_block)
	...
	TAG_REFL_STRING_ID(third_person_variant)
REFL_END

TAG_REFL_TAG_BLOCK_DEF(s_globals_group_definition::s_falling_damage_block)
	TAG_REFL_REAL_BOUNDS(harmful_falling_distance)
