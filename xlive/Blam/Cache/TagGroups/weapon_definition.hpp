...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_predicted_resources_block)
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_magazines_block::s_magazines_equipment_block)
	TAG_REFL_PROPERTY(rounds)
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_magazines_block)
	...
	TAG_REFL_PROPERTY(rounds_loaded_maximum)
	...
	TAG_REFL_TAG_BLOCK(magazines_equipment)
REFL_END
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_barrels_block::s_firing_effects)
...
TAG_REFL_TAG_BLOCK_DEF(s_weapon_group_definition::s_barrels_block)
	TAG_REFL_PROPERTY(flags)
	TAG_REFL_PROPERTY(rounds_per_second_lower)
	TAG_REFL_PROPERTY(rounds_per_second_upper)
	...
	TAG_REFL_PROPERTY(shots_per_fire_lower)
	TAG_REFL_PROPERTY(shots_per_fire_upper)
	...
	TAG_REFL_PROPERTY(acceleration_time)
	TAG_REFL_PROPERTY(deceleration_time)
	TAG_REFL_PROPERTY(damage_error_lower)
	TAG_REFL_PROPERTY(damage_error_upper)
	TAG_REFL_PROPERTY(acceleration_time)
	TAG_REFL_PROPERTY(deceleration_time)
	TAG_REFL_ANGLE(minimum_error)
	TAG_REFL_ANGLE(error_angle_lower)
	TAG_REFL_ANGLE(error_angle_upper)
	...
	TAG_REFL_ANGLE(error_angle_lower_1)
	TAG_REFL_ANGLE(error_angle_upper_1)
	TAG_REFL_PROPERTY(first_person_offset_i)
	TAG_REFL_PROPERTY(first_person_offset_j)
	TAG_REFL_PROPERTY(first_person_offset_k)
	TAG_REFL_PROPERTY(damage_effect_reporting_type)
	...
	TAG_REFL_ANGLE(angle_change_per_shot_lower)
	TAG_REFL_ANGLE(angle_change_per_shot_upper)
	TAG_REFL_PROPERTY(acceleration_time_2)
	TAG_REFL_PROPERTY(deceleration_time__3)
...
TAG_REFL(s_weapon_group_definition)
	...
	TAG_REFL_STRING_ID(swap_or_dual_msg)
	...
	TAG_REFL_PROPERTY(detonation_delay_lower)
	TAG_REFL_PROPERTY(detonation_delay_upper)
	TAG_REFL_TAG_REFERENCE(detonating_effect)
	TAG_REFL_TAG_REFERENCE(detonation_effect)
	TAG_REFL_PROPERTY(weapon_flags)
	...
	TAG_REFL_ANGLE(damage_pyramid_angles_yaw)
	TAG_REFL_ANGLE(damage_pyramid_angles_pitch)
	...
	TAG_REFL_PROPERTY(magnification_range_lower)
	TAG_REFL_PROPERTY(magnification_range_upper)
	...
	TAG_REFL_PROPERTY(forward_movement_penalty)
	...
	TAG_REFL_TAG_BLOCK(predicted_resources_1)
	TAG_REFL_TAG_BLOCK(magazines)
	TAG_REFL_TAG_BLOCK(new_triggers)
	TAG_REFL_TAG_BLOCK(barrels)
	TAG_REFL_PROPERTY(max_movement_acceleration)
	TAG_REFL_PROPERTY(max_movement_velocity)
	TAG_REFL_PROPERTY(max_turning_acceleration)
	TAG_REFL_PROPERTY(max_turning_velocity)
	TAG_REFL_TAG_REFERENCE(deployed_vehicle)
	TAG_REFL_TAG_REFERENCE(age_effect)
	TAG_REFL_TAG_REFERENCE(aged_weapon)
	TAG_REFL_REAL_VECTOR3D(first_person_weapon_offset)
