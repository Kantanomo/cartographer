...
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_button_icons_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_waypoint_parameters::s_waypoint_arrows_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_dashlights_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_waypoint_arrows_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_waypoints_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_hud_sounds_block)
TAG_REFL_TAG_BLOCK_FLAT(s_hud_globals_group_definition::s_player_training_data_block)
