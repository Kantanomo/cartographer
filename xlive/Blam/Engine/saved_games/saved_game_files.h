...
#define k_enumerated_salt_count 512

// 4197
#define k_maximum_enumerated_total_save_game_files (k_maximum_enumerated_saved_game_files_any_type_per_memory_unit + k_maximum_enumerated_default_save_game_files)
