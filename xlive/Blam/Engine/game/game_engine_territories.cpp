...
void c_territories_engine::render_game_engine_elements(uint32 user_index)
{
...
void c_territories_engine::function_19()
{
...
void c_territories_engine::set_simulation_baseline_data(int32 unused, void* unk)
{
	INVOKE_TYPE(0x10C9AF, 0x0, void(__thiscall*)(c_game_engine*, int32, void*), this, unused, unk);
}

void c_territories_engine::build_simulation_update(void* unk, int32 unused, void* unk_2)
{
	INVOKE_TYPE(0x10D420, 0x0, void(__thiscall*)(c_game_engine*, void*, int32, void*), this, unk, unused, unk_2);
}

bool c_territories_engine::apply_simulation_update(int16 flags, int32 unused, void* unk)
{
	return INVOKE_TYPE(0x10D815, 0x0, bool(__thiscall*)(c_game_engine*, int16, int32, void*), this, flags, unused, unk);
}
