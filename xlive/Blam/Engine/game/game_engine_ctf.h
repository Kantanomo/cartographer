...
public:
	...
	virtual void get_player_killed_event_id(datum player_index, datum player_index_2, bool a3, int32 a4) override;
	...
	virtual bool apply_player_simulation_update(int16 abs_player_index, int8 flags, int32 unused, void* unk) override;
};