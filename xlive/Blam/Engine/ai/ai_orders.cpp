...
bool orders_verify_script_references(orders_definition* order, bool a2)
{
...
{
    /*
    if (script_index != NONE && script_index != hs_find_script_by_name(script_name))
    {
        const char* string = csprintf(
            g_temporary,
            NUMBEROF(g_temporary),
