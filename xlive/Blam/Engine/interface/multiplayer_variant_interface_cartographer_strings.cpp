...
wchar_t* g_multiplayer_variant_interface_cartographer_title_strings[k_language_count][k_variant_setting_parameter_type_cartographer_count] =
{
    // English
    {
        L"Engine mode",
    ...
    // German
    {
        ...
        L"Schwerkraft",
        L"Spawn-Schutz",
        L"Dub-Shot deaktivieren",
        L"Unverwundbare Spieler"
    },
    // French
    {
        L"Mode moteur",
        ...
        L"Désactiver le Dub Shot",
        L"Joueurs invincibles"
    },
    // Spanish
    {
        L"Modo de motor",
        ...
        L"Desactivar Dub Shot",
        L"Jugadores invencibles"
    },
    // Italian
    {
        L"Modalità motore",
        ...
        L"Disattivare Dub Shot",
        L"Giocatori invincibili"
    },
    // Korean
    {
        L"엔진 모드",
    ...
    // Portuguese
    {
        ...
        L"Gravidade",
        L"Proteção de spawn",
        L"Desativar Dub Shot",
        L"Jogadores invencíveis"
    }
};

wchar_t* g_multiplayer_variant_interface_cartographer_parameter_description_strings[k_language_count][k_variant_setting_parameter_type_cartographer_count] =
{
    // English
    {
        ...
        L"Prevents players from dub shotting weapons",
        L"Prevents players from taking damage"
    },
    // Japanese
    {
        ...
        L"プレイヤーが武器でダブルショットを行うのを防ぎます",
        L"プレイヤーがダメージを受けるのを防ぎます"
    },
    // German
    {
        ...
        L"Verhindert, dass Spieler mit Waffen Dub-Shots ausführen",
        L"Verhindert, dass Spieler Schaden nehmen"
    },
    // French
    {
        ...
        L"Empêche les joueurs de faire des Dub Shots avec les armes",
        L"Empêche les joueurs de subir des dégâts"
    },
    // Spanish
    {
        ...
        L"Impide que los jugadores hagan Dub Shot con las armas",
        L"Impide que los jugadores reciban daño"
    },
    // Italian
    {
        ...
        L"Impedisce ai giocatori di eseguire il Dub Shot con le armi",
        L"Impedisce ai giocatori di subire danni"
    },
    // Korean
    {
        ...
        L"플레이어가 무기로 더블샷을 사용하는 것을 방지합니다",
        L"플레이어가 피해를 받는 것을 방지합니다"
    },
    // Chinese
    {
        L"更改游戏的内部更新速率",
    ...
    // Portuguese
    {
        ...
        L"Impede que os jogadores façam Dub Shot com as armas",
        L"Impede que os jogadores recebam dano"
    }
};

wchar_t* g_multiplayer_variant_interface_cartographer_game_speed_strings[k_language_count][k_game_speed_modifier_count] =
{
    // English
    {
        L"Default",
...
wchar_t* g_multiplayer_variant_interface_cartographer_gravity_strings[k_language_count][k_game_gravity_modifier_count] =
{
    // English
    {
        L"Default",
...
wchar_t* g_multiplayer_variant_interface_cartographer_spawn_protection_strings[k_language_count][k_player_spawn_protection_timer_count] =
{
    // English
    {
        L"Default",
...
wchar_t* g_multiplayer_variant_interface_cartographer_engine_mode[k_language_count][2] =
{
    // English
    {
        L"Default",
