...
//
// EXACT td pattern (was a stock 4x4 Bayer approximation before):
...
//   that pixel turns on. It is a recursive dispersed-dot ordering but NOT the textbook Bayer
//   matrix — vs standard Bayer, T[0][1]/T[1][0] and T[0][2]/T[2][0] are swapped and T[0][3]
//   is 10 where Bayer's transpose gives 15.
//
