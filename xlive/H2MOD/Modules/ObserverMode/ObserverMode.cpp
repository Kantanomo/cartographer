...
namespace ObserverMode
{
	...
	void SightJackObject()
	{
		if (ObserverMode == observer_firstperson) {
			...
			auto control = PlayerControl::GetControls(0);
			PlayerControl::GetPlayerActions(currentPlayerIndex, &outActions);
			...
			//control->slave_object = outActions.;
			LOG_INFO_FUNC("{0} {1} {2}", control->slave_object, outActions.facing.yaw.rad, control->actions.facing.yaw.rad);
			//control->actions.facing = outActions.facing;
			//control->actions = outActions;
		}
	}
